...
function eap:scripts/explosive_arrow
...
function eap:scripts/compact_explosive_arrow
...
function eap:scripts/super_compact_explosive_arrow
...
function afp:scripts/electric_arrow
...
function eap:scripts/compact_electric_arrow
execute if entity @e[type=arrow,nbt={Color:2379932}] run execute as @e[type=arrow,nbt={Color:2379932}] run data merge entity @s {pickup:1b,damage:20d,PierceLevel:2b}
function eap:scripts/super_compact_electric_arrow
